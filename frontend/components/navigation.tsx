...
import { Home, MessageSquare, Edit, Sparkles, Eye, Brain, Wand2, Users, Ghost } from "lucide-react"
...
const navItems = [
  ...
  { href: "/chorus", icon: Users, label: "Chorus" },
  { href: "/antimatter", icon: Ghost, label: "Antimatter" },
